...
def ransac_ray_intersection(
    ...
    Hypothesis generation draws one ray from the reference tube and one
    from the matched-view pool.  Scoring uses the weighted inlier sum.
    """
    N         = len(origins)
...
def main():
    ...
    # ══════════════════════════════════════════════════════════════════════════
    #
    # Reference tube: view_000's camera + the original clicked patch.
    # (All 4 rotations correspond to the same physical content, so the
    # ray geometry is identical regardless of which rotation "won".)
    #
    # Matched tubes: each other view's best-matched patch.
    # ──────────────────────────────────────────────────────────────────────────
